...
jQuery(window).load(function(){
    var existing_metas = ["petsAllowed","property_area","property_bathrooms","property_bedrooms","property_id","property_location","property_price", "property_status", "property_year", "property_agent", "custom_map_data"]
